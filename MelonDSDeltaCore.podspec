Pod::Spec.new do |spec|
  ...
  spec.source_files  = "MelonDSDeltaCore/**/*.{swift}",
                       ...
                       "melonDS/src/net/*.{h,cpp}",
                       "melonDS/src/DSP_HLE/*.{h,cpp}",
                       "melonDS/src/debug/*.{h,cpp}",
                       ...
                       "melonDS/src/net/libslirp/src/*.{h,c}",
                       "melonDS/src/net/libslirp/slirp/*.h",
                       "melonDS/src/net/libslirp/glib/*.{h,c}"

  spec.exclude_files = "melonDS/src/GPU3D_OpenGL.cpp",
  ...
  spec.xcconfig = {
    "HEADER_SEARCH_PATHS" => '"${PODS_CONFIGURATION_BUILD_DIR}" "$(PODS_ROOT)/Headers/Private/MelonDSDeltaCore/melonDS/src" "$(PODS_ROOT)/Headers/Private/MelonDSDeltaCore/melonDS/src/net" "$(PODS_ROOT)/Headers/Private/MelonDSDeltaCore/melonDS/src/net/libslirp"',
